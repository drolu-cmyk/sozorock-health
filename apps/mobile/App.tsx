...
const copy = {
  en: {
    ...
    voicePrompt: "Tap to describe the access support you need.",
    ...
    emptyBody: "Availability changes as licensed providers and community partners join in your state. You may return later or ask a hub navigator for help.",
