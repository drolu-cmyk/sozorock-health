...
const nextConfig: NextConfig = {
  ...
  env: {
    ...
    EVIDENCE_STAGING_MAX_PER_NETWORK_5_MINUTES:
      process.env.EVIDENCE_STAGING_MAX_PER_NETWORK_5_MINUTES,
    ...
    REPOSITORY_COMMIT_SHA: process.env.REPOSITORY_COMMIT_SHA,
    BUILD_TIMESTAMP: process.env.BUILD_TIMESTAMP,
    EVIDENCE_DATABASE_MIGRATION_VERSION: process.env.EVIDENCE_DATABASE_MIGRATION_VERSION,
    EXPLORE_COGNITO_DOMAIN: process.env.EXPLORE_COGNITO_DOMAIN,
    EXPLORE_COGNITO_CLIENT_ID: process.env.EXPLORE_COGNITO_CLIENT_ID,
    EXPLORE_AUTH_COOKIE_SECRET_ARN: process.env.EXPLORE_AUTH_COOKIE_SECRET_ARN,
  },
