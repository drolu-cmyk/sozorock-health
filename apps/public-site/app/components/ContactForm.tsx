...
export function ContactForm() {
  ...
  return <form className="partner-form" onSubmit={submit} aria-describedby="contact-status">
    ...
    <p id="contact-status" className={`form-status ${state}`} role="status">{state === "sent" ? "Thank you. Your inquiry has been received." : state === "error" ? "We could not send this right now. Please email contact@sozorockfoundation.org." : "Please do not include medical or emergency details."}</p>
  </form>;
}
