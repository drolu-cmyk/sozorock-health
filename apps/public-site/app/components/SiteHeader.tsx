...
export function SiteHeader() {
  ...
  return <header className="site-header">
    <a className="brand-lockup" href="#top" aria-label="SozoRock Health home"><span className="wordmark-image"><img src="/brand/sozorock-wordmark-transparent.png" alt="SozoRock"/><sup aria-label="registered trademark">®</sup></span><span>HEALTH</span></a>
