...
export const exploreMetrics: ExploreMetricDefinition[] = [
  ...
  },
  {
    ...
    category: "Chronic conditions",
    field: "chd",
    plainLanguage: "The modeled share of adults living with coronary heart disease.",
    response: "Support prevention literacy and preparation for licensed provider-led care.",
    direction: "adverse",
    higherValueMeaning: "adverse",
  },
  {
    ...
    category: "Chronic conditions",
    field: "stroke",
    plainLanguage: "The modeled share of adults who have experienced a stroke.",
    response: "Support prevention literacy and readiness for established services.",
    direction: "adverse",
    higherValueMeaning: "adverse",
  },
  {
    ...
    category: "Chronic conditions",
    field: "cancer",
    plainLanguage: "The modeled share of adults living with a cancer diagnosis other than skin cancer.",
    response: "Support prevention and screening literacy while licensed care remains with providers.",
    direction: "adverse",
    higherValueMeaning: "adverse",
  },
  {
    ...
    category: "Chronic conditions",
    field: "casthma",
    plainLanguage: "The modeled share of adults living with current asthma.",
    response: "Support respiratory-health literacy and preparation for licensed care.",
    direction: "adverse",
    higherValueMeaning: "adverse",
  },
  {
  ...
  },
  {
    ...
    category: "Prevention",
    field: "checkup",
    plainLanguage: "The modeled share of adults who had a routine checkup in the past year.",
    response: "Use as protective context when considering readiness and prevention activity.",
    direction: "protective",
    higherValueMeaning: "favorable",
  },
  {
    ...
    category: "Prevention",
    field: "cholscreen",
    plainLanguage: "The modeled share of eligible adults whose cholesterol was checked within the measure period.",
    response: "Use as protective context for prevention and screening-readiness conversations.",
    direction: "protective",
    higherValueMeaning: "favorable",
  },
  {
  ...
  },
  {
    ...
    category: "Access barriers",
    field: "housinsecu",
    plainLanguage: "The modeled share of adults experiencing housing insecurity.",
    response: "Consider trusted, place-based support that connects people with existing services.",
    direction: "adverse",
    higherValueMeaning: "adverse",
  },
  {
    key: "shututility",
    label: "Utility shutoff or threat",
    category: "Access barriers",
    field: "shututility",
    plainLanguage: "The modeled share of adults reporting a utility shutoff or threat during the measure period.",
    response: "Use as practical context for local support and readiness planning.",
    direction: "adverse",
    higherValueMeaning: "adverse",
  },
  {
