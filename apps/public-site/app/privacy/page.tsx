...
export default function PrivacyPage() {
  return (
    <LegalPage eyebrow="Public policy" title="Privacy notice" updated="July 11, 2026">
      ...
      <h2>Voice Access</h2>
      <p>Microphone access begins only after you review the voice notice and agree. When live voice is available, an approved voice-service provider processes microphone audio to provide the non-clinical response. Do not share medical records or protected health information. You can stop the session at any time, and text or tap options remain available. This website does not intentionally retain raw audio. The notice presented before a voice session will identify the provider and applicable processing terms.</p>
